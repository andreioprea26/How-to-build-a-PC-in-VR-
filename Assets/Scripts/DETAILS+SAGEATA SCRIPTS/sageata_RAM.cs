...
public class sageata_RAM : MonoBehaviour
{   
    ...
    public void spawn()
    {
        ...
        obj_to_spawn.tag = "ArrowRAM";
        
    }

    public void DestroyScriptInstance()
    {
        cpuSocket = GameObject.Find("RAM socket 1");
        testCPU = cpuSocket.GetComponent<ram1SocketCheck>().variabila_RAM1;

        // Removes this script instance from the game object
        spawn_to_delete = GameObject.FindWithTag("ArrowRAM");
